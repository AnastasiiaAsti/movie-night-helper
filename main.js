...
let camera, scene, renderer, geometry, material, mesh, clock, delta, cubeSineDriver, light, smokeParticles, smokeTexture, smokeMaterial, smokeGeo;
...
function init() {
    ...
    smokeTexture = new THREE.TextureLoader().load("/assets/Smoke-Element.png");
